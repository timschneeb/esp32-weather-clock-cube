...
lv_obj_t * clock_screen_create(void)
{
    ...
    lv_obj_set_style_text_font(date, montserrat_22_c_array, 0);
    ...
    lv_obj_set_style_flex_main_place(row_0, LV_FLEX_ALIGN_SPACE_EVENLY, 0);
    ...
    lv_obj_set_height(row_1, 70);
    lv_obj_set_style_flex_main_place(row_1, LV_FLEX_ALIGN_SPACE_EVENLY, 0);
    ...
    lv_obj_set_style_flex_main_place(column_1, LV_FLEX_ALIGN_CENTER, 0);
    ...
    lv_label_set_text(min_temperature, "Min: -8.8°C");
    lv_obj_set_style_text_font(min_temperature, montserrat_22_c_array, 0);
    ...
    lv_label_set_text(max_temperature, "Max: 24.8°C");
    lv_obj_set_align(max_temperature, LV_ALIGN_CENTER);
    lv_obj_set_style_text_font(max_temperature, montserrat_22_c_array, 0);
    ...
    lv_obj_set_height(weather_icon, lv_pct(100));
    lv_obj_set_flex_grow(weather_icon, 1);
    lv_image_set_inner_align(weather_icon, LV_IMAGE_ALIGN_CENTER);
    lv_obj_set_style_min_width(weather_icon, 70, 0);
    lv_image_set_src(weather_icon, img_weather_placeholder);
